...
// Taulukko väreistä
const colors = [
    { name: "Red Orange", hex: "#ff4d00" },
    { name: "Goldfish", hex: "#ff9913" },
    { name: "Orange", hex: "#ed7014" },
    { name: "Tiger's Eye", hex: "#e08d3c" },
    { name: "Rustic Orange", hex: "#d78c3d" },
    { name: "Calm Orange", hex: "#fab972" },
    { name: "Alloy", hex: "#c35214" },
    { name: "Tiger", hex: "#f96815" },
    { name: "Carrot", hex: "#ed9121" },
    { name: "Marmalade", hex: "#d16002" },
    { name: "Jasper", hex: "#e89149" },
    { name: "Salamander", hex: "#f05e23" }
];
