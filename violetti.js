...
const colors = [
    ...
    { name: "Medium Purple", hex: "#8968cd" },
    { name: "Early Bird", hex: "#cea2fd" },
    { name: "Mauve", hex: "#e0b0ff" },
    { name: "Thistle", hex: "#d8bfd8" },
    { name: "Grape Jelly", hex: "#3e2f84" },
    { name: "Chinese Violet", hex: "#856088" },
    { name: "Tacao", hex: "#6f3096" },
    { name: "Violet", hex: "#8f00ff" },
    { name: "Electric Purple", hex: "#b24bf3" },
    { name: "Bright Lilac", hex: "#ce8cf8" }
];
