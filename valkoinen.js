...
const colors = [
    ...
    { name: "Off White", hex: "#faf9f9" },
    { name: "Pearl White", hex: "#f8f6f0" },
    { name: "White Dove", hex: "#f0efe7" },
    { name: "Floral White", hex: "#fffaf0" },
    { name: "Antique White", hex: "#faebd7" },
    { name: "Linen", hex: "#faf0e6" },
    { name: "Rice", hex: "#fbfcfa" },
...
function displayColors() {
    ...
    colors.forEach((color) => {
        ...
        swatch.innerHTML = `
            <div class="color-box-savy" style="background-color: ${color.hex}; cursor: pointer; border: 1.5px solid grey;"></div>
            <div class="label-savy" style="border: 1.5px solid grey;">
                <h4>${color.name}</h4>
                <p>${color.hex}</p>
            </div>
        `;
